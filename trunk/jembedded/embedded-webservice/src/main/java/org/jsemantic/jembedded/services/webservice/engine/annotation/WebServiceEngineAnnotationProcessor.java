...
import org.jsemantic.jembedded.core.annotation.AnnotationProcessor;
import org.jsemantic.jservice.core.service.Service;

public class WebServiceEngineAnnotationProcessor implements AnnotationProcessor {
	...
	public boolean processAnnotation(Service webService, Class<?> service) {
		if (service.isAnnotationPresent(WebServiceEngine.class)) {
			if (service
					.isAnnotationPresent(WebServiceEngineConfiguration.class)) {
				return true;
			}
			return true;
		}
